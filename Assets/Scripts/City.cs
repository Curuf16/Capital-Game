...
public class City : MonoBehaviour
{
    ...
    public TextMeshProUGUI bestJobs;
    ...
    public void Update()
    {
        if(curJobs>PlayerPrefs.GetInt("bestJobs"))
        {
            bestJobs.text = " " + curJobs;
            PlayerPrefs.SetInt("bestJobs", curJobs);
        }
        else
        {
            bestJobs.text = PlayerPrefs.GetInt("bestJobs", curJobs).ToString();
        }
    }
